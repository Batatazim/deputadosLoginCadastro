...
const Deputados = () => {
    ...
    const pesquisarDeputadosigla = async (event) => {
        getDeputadosigla(event.target.value).then(response => setDeputados(response))
    }
  ...
  return (
    <div style={{ marginTop: "120px" }}>
            <Card className='mt-5 mb-5'>         
               ...
               placeholder='Pesquisar deputados por sigla de estado...' 
               type="Text" 
               onChange={pesquisarDeputadosigla}
              />
          </Card>  
        <Card>
